...
const CourseCard = ({ course }: CourseCardProps) => {
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden cursor-pointer hover:bg-teal-100 hover:shadow-xl transition-all duration-300">
      <div>
        <Image
          src={course.image}
          alt={course.title}
      ...
      <div className="p-4">
        <p className="ml-auto relative z-10 h-20 w-20 flex items-center text-lg font-bold justify-center flex-col mt-[-4rem] rounded-full bg-rose-700 text-white">
          ${course.price}
        </p>
