...
const MobileNav = ({ showNav, closeNav }: MobileNavProps) => {
  ...
  return (
    <div>
      ...
      {/* Sidebar */}
      <div
        className={`text-white fixed ${navOpen} flex justify-center flex-col h-full transform transition-transform duration-500 w-[80%] sm:w-[60%] bg-indigo-900 space-y-6 z-[10001]`}
      >
        {/* Nav links */}
        {NAV_LINKS.map((link) => (
          <Link
